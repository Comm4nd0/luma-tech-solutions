...
def site(request):
    return {
        ...
        "SITE_STREET_ADDRESS": settings.SITE_STREET_ADDRESS,
        "SITE_POSTAL_CODE": settings.SITE_POSTAL_CODE,
        "SITE_GEO_LATITUDE": settings.SITE_GEO_LATITUDE,
        "SITE_GEO_LONGITUDE": settings.SITE_GEO_LONGITUDE,
        "SITE_GOOGLE_BUSINESS_URL": settings.SITE_GOOGLE_BUSINESS_URL,
        "SITE_EXTRA_SAME_AS": settings.SITE_EXTRA_SAME_AS,
        "SITE_LEGAL_NAME": settings.SITE_LEGAL_NAME,
        "SITE_COMPANY_NUMBER": settings.SITE_COMPANY_NUMBER,
