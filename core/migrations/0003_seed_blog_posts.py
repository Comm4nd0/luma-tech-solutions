...
<p>If you're in Berkshire, Buckinghamshire or the surrounding area and tired of patchy coverage, <a href="/contact/">get in touch</a>. We'll walk the property, do a proper on-site survey and tell you honestly whether it's a £200 fix or a proper rebuild. No pressure, no day rates.</p>
"""
...
<p>Once we've got rough zones, we walk the property top-to-bottom and sketch the install before drilling anything. We measure cable runs, check sight-lines from each proposed camera position, and identify blind spots from ground level — the sort of thing that's easy to miss until day-of-install. By the time install day comes round, we know exactly where every camera goes and how the cable runs.</p>
<p>A written placement plan is handed over to you with the runbook — useful for insurance, useful if we ever expand the system, useful as a record of the property as it was.</p>
...
<ul>
  ...
  <li><strong>Professional — £59/month.</strong> Adds same-day response, an annual on-site visit, smart-home tweaks included. Right for households or small businesses that depend on the tech.</li>
...
POSTS = [
    ...
    },
    {
        ...
        "pillar": "security",
        "excerpt": (
            "Coverage zones, height, angle, sun and night vision — how we "
            "plan CCTV installs that actually catch what matters."
        ),
        "meta_description": (
